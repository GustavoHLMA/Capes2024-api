...
const axios_1 = __importDefault(require("axios")); // Certifique-se de ter essa linha no topo do arquivo
class ChatService {
        ...
        try {
            ...
            if (error.response) {
                ...
                if (error.response.status === 429) {
                    ...
                    throw new Error(`Erro inesperado: ${error.response.status}. ${(_a = error.response.data.error) === null || _a === void 0 ? void 0 : _a.message}`);
                }
            }
            else {
